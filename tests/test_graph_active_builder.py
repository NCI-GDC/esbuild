...
@pytest.mark.parametrize('doc_type,path,count', [
    ...
    ('cases', '[*].primary_site', 4),
    ('cases', '[*].disease_type', 4),
    ('cases', '[*].project.project_id', 4),
    ('cases', '[*].project.disease_type', 4),
    ('cases', '[*].project.primary_site', 4),
    ('cases', '[*].project_id', 0),
...
@pytest.mark.parametrize('doc_type, count', [('annotations', 4), ('projects', 2),
                                             ('cases', 4), ('files', 10)])
...
@pytest.mark.parametrize('doc_type,path,count,expected', [
    ...
    ('cases', '[*].disease_type', 4, {'Breast Invasive Carcinoma',
                                      'Prostate Adenocarcinoma',
                                      'Rectum Adenocarcinoma'}),
    ('cases', '[*].primary_site', 4, {'Breast', 'Prostate', 'Rectum'}),
