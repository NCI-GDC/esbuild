...
Module for creating legacy graph structure.
...
def create_prelude_nodes(driver):
    import_center_codes(driver, os.path.join(DATA_DIR, "centerCode.csv"))
    import_tissue_source_site_codes(driver, os.path.join(DATA_DIR, "tissueSourceSite.csv"))
    insert_classification_nodes(driver)
    insert_project_nodes(driver, os.path.join(DATA_DIR, "projects.csv"))
