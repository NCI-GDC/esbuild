...
@pytest.mark.parametrize(
    ...
    [
        ("files", "[*].type.[*]", {"pathology_report": 2,},),
        ("files", "[*].data_type.[*]", {"Pathology Report": 2,},),
        ("files", "[*].submitter_id.[*]", {"pr_pathology_1": 1, "pr_pathology_2": 1,},),
        ("cases", "[*].files.[*].type.[*]", {"pathology_report": 2,},),
    ],
)
