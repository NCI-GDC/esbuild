...
build_metadata = [{u'build_projects': [u'TCGA-DLBC',
                                       u'TCGA-PRAD',
                                       u'TARGET-OS',
                                       u'TARGET-RT',
                                       u'TCGA-STAD'],
                   u'commit_hash': u'a07731187614da9788fc453dcfd22aac8222592b',
                   u'counts': {u'annotation': 10,
                               u'case': 16,
                               u'file': 9,
                               u'project': 5}},
                  {u'build_projects': [u'TARGET-NBL',
                                       u'FM-AD',
                                       u'TCGA-THYM'],
                   u'commit_hash': u'a07731187614da9788fc453dcfd22aac8222592b',
                   u'counts': {u'annotation': 4,
                               u'case': 15,
                               u'file': 5,
                               u'project': 3}}]
...
file_docs = [
    {"cases": [{"project": {"project_id": "TCGA-DLBC"}},
               {"project": {"project_id": "TCGA-DLBC"}}]},
    {"cases": [{"project": {"project_id": "TCGA-PRAD"}},
               {"project": {"project_id": "TCGA-PRAD"}}]},
