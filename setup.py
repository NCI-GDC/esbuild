...
setup(
    ...
    install_requires=[
        ...
        "indexclient @ git+ssh://git@github.com/NCI-GDC/indexclient.git@huzaifa/gitlab-testing#egg=indexclient",
    ...
    extras_require={
        "dev": [
            ...
            "indexclient[pytest_indexd] @ git+ssh://git@github.com/NCI-GDC/indexclient.git@huzaifa/gitlab-testing#egg=indexclient[pytest_indexd]",
        ]
    },
    scripts=[
        "bin/esbuild-cli",
