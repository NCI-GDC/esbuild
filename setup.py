...
setup(
    ...
    install_requires=[
        ...
        "indexclient @ git+ssh://git@github.com/NCI-GDC/indexclient.git@feat/dev-2132-use-nexus-and-remove-travis#egg=indexclient",
    ...
    extras_require={
        "dev": [
            ...
            "indexclient[pytest_indexd] @ git+ssh://git@github.com/NCI-GDC/indexclient.git@feat/dev-2132-use-nexus-and-remove-travis#egg=indexclient[pytest_indexd]",
        ]
    },
    scripts=[
        "bin/esbuild-cli",
