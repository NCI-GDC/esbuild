...
setup(
    ...
    install_requires=[
        ...
        "requests~=2.7",
        "SQLAlchemy==1.3.3",
        "psqlgraph @ git+ssh://git@github.com/NCI-GDC/psqlgraph.git@3.1.0#egg=psqlgraph",
        "gdcdictionary @ git+ssh://git@github.com/NCI-GDC/gdcdictionary.git@2.3.1#egg=gdcdictionary",
        "gdcdatamodel @ git+ssh://git@github.com/NCI-GDC/gdcdatamodel.git@3.2.0#egg=gdcdatamodel",
        ...
        "gdcmodels @ git+ssh://git@github.com/NCI-GDC/gdc-models.git@2.8.1-rc.1#egg=gdcmodels",
