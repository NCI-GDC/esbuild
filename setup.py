...
setup(
    ...
    install_requires=[
        ...
        "indexclient @ git+ssh://git@github.com/NCI-GDC/indexclient.git@feat/DEV-2133-py37-plus#egg=indexclient",
    ...
    extras_require={
        "dev": [
            ...
            "indexclient[pytest_indexd] @ git+ssh://git@github.com/NCI-GDC/indexclient.git@feat/DEV-2133-py37-plus#egg=indexclient[pytest_indexd]",
        ]
    },
    scripts=[
        "bin/esbuild-cli",
