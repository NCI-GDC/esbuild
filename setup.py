...
setup(
    ...
    install_requires=[
        ...
        "gdcdictionary @ git+ssh://git@github.com/NCI-GDC/gdcdictionary.git@2.4.2#egg=gdcdictionary",
        "gdcdatamodel @ git+ssh://git@github.com/NCI-GDC/gdcdatamodel.git@3.6.5#egg=gdcdatamodel",
        "gdcdatamodel2 @ git+ssh://git@github.com/NCI-GDC/gdcdatamodel2.git@2.4.2#egg=gdcdatamodel2",
