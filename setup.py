...
setup(
    ...
    install_requires=[
        ...
        "gdcdictionary @ git+ssh://git@github.com/NCI-GDC/gdcdictionary.git@2.3.1-rc.0#egg=gdcdictionary",
        "gdcdatamodel @ git+ssh://git@github.com/NCI-GDC/gdcdatamodel.git@3.2.0-rc.4#egg=gdcdatamodel",
        "gdc_ng_models @ git+ssh://git@github.com/NCI-GDC/gdc-ng-models.git@1.5.2-rc.5#egg=gdc_ng_models",
        ...
        "gdcmodels @ git+ssh://git@github.com/NCI-GDC/gdc-models.git@43859f7bb80e22954b7ed4a065fd150eff48d4ea#egg=gdcmodels",
